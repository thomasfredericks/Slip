...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 76.0, 57.0, 60.0, 20.0 ],
					"text" : "route /C3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 202.0, 150.0, 34.0 ],
					"text" : "Il faut refresh pour que ça marche"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 93.0, 50.0, 20.0 ]
				}
...
,
					"patching_rect" : [ 76.0, 173.0, 335.0, 80.0 ],
					"varname" : "patcher"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 350.0, 50.0, 20.0 ]
				}
